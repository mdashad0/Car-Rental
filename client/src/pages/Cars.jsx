...
const {cars, axios} = UseAppContext()
  ...
  useEffect(() => {
    isSearchDate && searchCarAvailablity()
  },[])

  useEffect(()=>{
    cars.length > 0 && !isSearchDate && applyFilter()
  },[input, cars])

  return (
    <div>

      <div className='flex flex-col items-center py-20 bg-blue-50 max-md:py-4'>
        <Title title='Available Cars' subTitle='Browse our Section of Premium Vehicle
        available for your next adventure'/>
        
        <div className='flex items-center bg-white px-4 mt-6 max-w-140 w-full
        h-12 rounded-full shadow '>
      ...
      <div className='px-6 md:px-16 lg:px-4 xl:px-32 mt-10'>
