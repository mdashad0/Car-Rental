...
const Testimonial = () => {
    ...
    const testimonials = [
       ...
       { name: "Ashraf ",
          location: "Tukuliya Petrol-Pump",
          image: assets.testimonial_image_1,
           testimonial:"I highly recommed carRental ! Their fleet is amazing, and I always feel like I'm getting the best deal with excellent service."
        },
        ];
  ...
  return (
      <motion.div className="py-28 px-6 md:px-16 lg:px-24 xl:px-44">
            ...
            <Title title="What our Customers Say" subTitle="Discover Why discerning travelers choose stayVenture
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 mt-18">
                {testimonials.map((testimonial, index) => (
                    ...
                    key={index} className="bg-white p-6 rounded-xl shadow-lg hover:-translate-y-1
