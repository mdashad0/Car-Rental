    ...
    <div className='px-6 md:px-16 lg:px-24 xl:px-32 mt-16'>
      ...
      <div className='grid grid-cols-1 lg:grid-cols-3 gap-8 lg:gap-12'>
              ...
              <div className='grid grid-cols-2 sm:grid-cols-4 gap-4'>
                {[
                  {icon: assets.users_icon, text: `${car.seating_capacity}
                    Seats`},
                  {icon: assets.fuel_icon, text: car.fule_type},
                  {icon: assets.car_icon, text: car.transmission},
                  {icon: assets.location_icon, text: car.location},
                ].map(({icon, text})=>(
                  <div key={text} className='flex flex-col items-center bg-blue-50
                  p-4 rounded-lg'>
          ...
          text-gray-500'>
            ...
            font-semibold'>{currency}{car.pricePerDay}<span className='text-base
            ...
            cursor-pointer  bg-blue-600 hover:bg-blue-700'>Book Now</button>
