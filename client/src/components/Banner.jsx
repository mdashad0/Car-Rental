...
const Banner = () => {
  return (
    ...
    <div className='text-white'>
        ...
        <p className='mt-2'>Monetize Your vehicles effortlessly by listing it on CarRental.</p>
        ...
        whileTap={{scale: 0.95}}
        className='px-6 py-2 bg-black/45 hover:bg-black/65 transition-all
        text-primary rounded-lg text-sm mt-4 cursor-pointer '>List Your car</motion.button>
    </div>

    <motion.img
        initial={{opacity: 40, x: 50 }}
