...
const Hero = () => {
  ...
  return (
    ...
    bg-light text-center'>
        ...
        className='text-4xl md:text-5xl font-semibold'>Luxury Cars on Rents</motion.h1>

        <motion.form
        initial={{sclae:0.95, opacity: 0, y:50}}
        ...
        bg-white shadow-[0px_8px_20px_rgba(0,0,0,0.1)]'>
            ...
            gap-10 min-md:ml-8'>
                ...
                <div className='flex flex-col items-start gap-2'>
                    ...
                    <input value={pickupDate} onChange={e=>setPickupDate(e.target.value)} type="date" id="pickup-date" min={new Date().toDateString()
